...
class BaseDeploy
{
	 ...
	 */
    public static function checkDatabaseFiles($action, $path_prefix, $filenames)
    {
        $classes = array();
	 ...
	 * @return string
	 */
    protected static function inputPrompt($message, $default = '', $isPassword = false)
    {
	 ...
	 * @return string
	 */
    protected static function getPassword($stars = false)
    {
        // Get current style
